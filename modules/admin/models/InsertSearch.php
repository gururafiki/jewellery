...
/**
 * InsertSearch represents the model behind the search form about `app\modules\admin\models\Insert`.
 */
class InsertSearch extends Insert
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'carat', 'count_unical', 'count_total', 'count_sold', 'count_available'], 'integer'],
            [['name'], 'safe'],
